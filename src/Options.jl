...
type Options{T<:OptionsChecking}
    ...
    check_lock::AbstractVector{Bool}
end
...
function docheck_common(o::Options,checkflag::AbstractVector{Bool})
...
function docheck(o::Options{CheckNone},checkflag::AbstractVector{Bool})
    clearcheck(o,checkflag)
end
function docheck(o::Options{CheckWarn},checkflag::AbstractVector{Bool})
...
function docheck(o::Options{CheckError},checkflag::AbstractVector{Bool})
    unused, msg = docheck_common(o,checkflag)
...
function clearcheck(o::Options,checkflag::AbstractVector{Bool})
